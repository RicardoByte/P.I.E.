...
Implementada em JavaScript (ES6+), essa camada controla o funcionamento interno da extensão e implementa as regras de negócio do sistema. 
...
Como o projeto não utiliza um servidor próprio, o armazenamento é realizado utilizando a Browser Storage API (Chrome Storage/Firefox Storage).
